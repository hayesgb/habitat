...
def main(df, zipcodes=filenames.zipcode_dfile, predict=False):
    ...
    if predict is True:
        ...
        pipe = joblib.load(filenames.classifier_pipeline)           # Load the trained pipeline
        clf = joblib.load(filenames.trained_classifier)                # assign the saved classifier
    ...
    if predict is False:
        ...
        mapper = DataFrameMapper([
            ...
            ('1stgft$v2_$300', None),
            ('1stgft$v2_$500', None),
            ('1stgft$v2_$1,000', None),
            ('1stgft$v2_$2,500', None),
            ('1stgft$v2_$150k', None),
            ('noemail', None),
            ('gmail', None),
            ('yahoo', None),
            ('comcast', None),
           ...
           ('1gftevnt$_1000', None),
           ('1gftevnt$_1000+', None),
           ('log10(1stgft$v2)', None),
           ('1stgft$v2', None),
           (['wealthy'], Imputer()),
           (['wages/household'], Imputer()),
           (['totalwages'], Imputer()),
           (['landarea'], Imputer()),
           (['housingunits'], Imputer()),
            (['mnseasonalunemployment'], None),
            ])
